...
formulario.addEventListener("submit", function (e) {
    ...
    if (Stock.value === "" , !regex.test(Stock.value)) {
        stockError.textContent = "Este campo es obligatorio(Solo se aceptan numeros)";
    ...
    if (Price.value === "", !regex.test(Price.value) ) {
        priceError.textContent = "Este campo es obligatorio(Solo se aceptan numeros)";
    ...
    if (Discount.value === "" , !regex.test(Discount.value)) {
        discountError.textContent = "Este campo es obligatorio(Solo se aceptan numeros)";
